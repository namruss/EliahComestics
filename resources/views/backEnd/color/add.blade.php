            ...
            <form role="form" method="POST" action="{{route('color.store')}}">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        @enderror
                        <input type="text" class="form-control @error('name') is-invalid  @enderror " placeholder="Enter name color..." name="name" value="{{old('name')}}">
                    </div>
                    <div class="form-group">
                        @error('color_code')
                        ...
                        <span class="color-picker">
                            <label for="colorPicker">
                                <input type="color" value="{{old('color_code')}}" id="colorPicker" name="color_code" class="form-control @error('color_code') is-invalid  @enderror ">
                            </label>
                        </span>                      
                    </div>
                   <div class="row">
